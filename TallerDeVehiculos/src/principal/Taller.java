...
import taller.GestionPartes;
import taller.Lector;
...
public class Taller {
	...
	public static void main(String[] args) {
		GestionPartes gestion = new GestionPartes();
		int opcion = 0;
		do {
			...
			System.out.println("Seleccione operación a realizar (1-5): ");
